(defproject ode_solver "0.1.0-SNAPSHOT"
  ...
  :profiles {:dev {:source-paths ["env/dev/clj"]
                   ...
                   :repl-options {:init-ns ode-solver.server
                   ...
                   :figwheel {:http-server-root "public"
                              ...
                              :ring-handler ode-solver.server/http-handler}
